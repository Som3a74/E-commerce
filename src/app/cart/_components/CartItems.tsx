...
export default function CartItems({ CartData }: props) {
            ...
            <div className="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
              <div className="relative pr-9 sm:grid sm:grid-cols-4 sm:gap-x-6 sm:pr-0">
                <div className="flex flex-col gap-1 col-span-3">
                  ...
                  <p className="text-xs">
                    Brand: <span className="font-medium">{ele.product.brand.name}</span>
                  </p>
                  <p className="text-xs">
                    Category:{" "}
                    <span className="font-medium">{ele.product.category.name}</span>
                  </p>
